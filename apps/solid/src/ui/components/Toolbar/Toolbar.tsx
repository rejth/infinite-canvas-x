        ...
        {(item) => (
          <li>
            <button
              ...
              class={cn('tool', item.disabled && 'disabled')}
              disabled={item.disabled}
              onClick={() => handleClick(item.type)}
            >
              <span class={cn('icon', item.type === toolbar().tool && !item.disabled && 'active')}>
                <Icon name={item.icon} color={item.disabled ? 'disabled' : undefined} />
              </span>
