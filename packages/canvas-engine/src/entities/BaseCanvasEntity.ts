import { DEFAULT_RECT_SIZE, DEFAULT_SCALE } from '../constants'
import type { PixelRatio, RectCorners } from '../interfaces'
...
export abstract class BaseCanvasEntity<T extends BaseDrawOptions>
  implements BaseCanvasEntityInterface<T>
{
