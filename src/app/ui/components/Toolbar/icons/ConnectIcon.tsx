  ...
  return (
    <svg viewBox="0 -9 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        fill="#00263A"
      />
      <circle r="2.25" transform="matrix(1 0 0 -1 3.54199 3.2746)" fill="white" stroke="#00263A" strokeWidth="1.5" />
      <circle r="2.3" transform="matrix(1 0 0 -1 21.7061 5.97119)" fill="white" stroke="#00263A" strokeWidth="1.4" />
    </svg>
  );
};
