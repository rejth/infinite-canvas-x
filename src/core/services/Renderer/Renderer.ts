...
import { Colors, TextAlign, TextDecoration } from '@/core/interfaces';
import {
...
import { geometry, BezierCurve, SplineArcLengthMap } from '@/core/math';

import { ProxyCanvasRenderingContext2D, RenderMode } from '@/core/services/RenderManager';
import { SPATIAL_TILE_SIZE } from '@/core/services/SpatialTileIndex';
